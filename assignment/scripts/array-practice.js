...
let favoriteFoods = ["Tacos", "Chicken and Rice", "Mexican food", "Chips and salsa"];
...
console.log("There are this many members of my list: ", numberOfFoods);
...
let lastAnimalIndicator = animalArray.length-1;
lastAnimal = animalArray[lastAnimalIndicator];
console.log('The last animal is ', lastAnimal);
...
console.log("Removed "+ lastColor + " so colors are now: " + colors)
...
console.log("Removed "+ firstColor + " so colors are now: " + colors)
